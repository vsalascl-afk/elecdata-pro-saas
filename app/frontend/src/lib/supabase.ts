...
// Read from environment variables (Vercel) with hardcoded fallbacks for local dev
const SUPABASE_URL =
  import.meta.env.VITE_SUPABASE_URL || "https://wdkgogppdrjnwcviflrn.supabase.co";
const SUPABASE_KEY =
...
// Set this in Vercel as VITE_SUPABASE_SERVICE_KEY
